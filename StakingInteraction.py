...
tx_hash = contract.functions.createStake(100).transact()
web3.eth.waitForTransactionReceipt(tx_hash)
...
contract.functions.distributeStakingRewards().call()
...
tx_hash = contract.functions.removeStake(100).transact()
web3.eth.waitForTransactionReceipt(tx_hash)

tx_hash = contract.functions.withdrawStakingRewards().transact()
web3.eth.waitForTransactionReceipt(tx_hash)

print(f'Updated client1 Balance: {contract.functions.getBalanceFor(client1).call()}')
